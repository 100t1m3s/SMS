...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        DatabaseInstance userServiceDb =
                createDatabase("UserServiceDB", "user-service-db");
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "1ed12e7db6fd5eaa19056626be346d225660fe8bdc559fb3e47d73ab206f6bbf"));
